...
class template {
	...
	function template() {
		ob_start();
		$this->defaulttpldir = UC_ROOT.'./templ/default';
		$this->tpldir = UC_ROOT.'./templ/default';
		$this->objdir = UC_DATADIR.'./templ';
		$this->langfile = UC_ROOT.'./templ/default/templates.lang.php';
